...
use_cuda = True
model_path = '/kuacc/users/ocaki13/hpc_run/workfolder/us1_35_transunetsettings_woff/epoch87.pt'
model = UNet(1, 4, 64,
             use_cuda, False, 0.2)
...
test_path = '/kuacc/users/ocaki13/hpc_run/ultrasoundSegmentationDatasetv1_resized/test'
...
for img_path in tqdm(image_list):
    ...
    # pred_label_imgs = NoiseFiltering(pred_label_imgs,2000)
    ...
    cv2.imwrite(os.path.join(save_dir, image_name+'_pred.png'),  cv2.cvtColor(rgb_mask_pred, cv2.COLOR_RGB2BGR))
